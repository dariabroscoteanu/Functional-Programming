...
--Să se scrie o funct, ie eeny care întoarce “eeny” pentru input par s, i “meeny” pentru input impar. Hint:
...
--Să se scrie o funct, ie fizzbuzz care întoarce “Fizz” pentru numerele divizibile cu 3, “Buzz” pentru
...
--takefinal - pentru o listă dată ca parametru s, i un număr n, întoarce lista cu ultimele n elemente.
...
--remove - pentru o listă s, i un număr n se întoarce lista din care se s, terge elementul de pe pozit, ia n.
...
--myreplicate - pentru un întreg n si o valoare v întoarce lista de lungime n ce are doar elemente egale
--cu v. Să se scrie s, i prototipul functiei.
myreplicate :: Int -> Int -> [Int]
myreplicate 0 v = []
myreplicate n v = v:myreplicate (n-1) v

--sumImp - pentru o listă de numere întregi, calculează suma valorilor impare. Să se scrie s, i prototipul
--functiei.
sumImp :: [Int] -> Int
sumImp [] = 0
sumImp (x:xs) = 
...
--totalLen - pentru o listă de s, iruri de caractere, calculează suma lungimilor s, irurilor care încep cu
--caracterul ‘A’. 
totalLen :: [String] -> Int
totalLen [] = 0
totalLen (x:xs) =
